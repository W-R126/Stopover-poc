...
import css from './PassengerSelector.module.css';
...
export default class PassengerSelector extends React.Component<
  ...
  PassengerSelectorState
> {
  static readonly defaultProps: Pick<PassengerSelectorProps, 'tabIndex'> = {
    tabIndex: 0,
  };
  ...
  private get passengersDetailed(): JSX.Element {
    ...
    return (
      <span className={css.PassengersDetailed} ref={this.passengersDetailedRef}>
        Passengers
        {'  '}
        <span className={css.ActiveText}><strong>{result}</strong></span>
      </span>
    );
  }
  ...
  render(): JSX.Element {
    ...
    const classList = [css.PassengerSelector];
